...
import (
	...
	"screen-ocr-llm/src/process"
	"screen-ocr-llm/src/router"
	"screen-ocr-llm/src/screenshot"
	"screen-ocr-llm/src/singleinstance"
	"screen-ocr-llm/src/tray"

	clipboardProcess "screen-ocr-llm/src/processes/clipboard"
	configProcess "screen-ocr-llm/src/processes/config"
	hotkeyProcess "screen-ocr-llm/src/processes/hotkey"
	ocrProcess "screen-ocr-llm/src/processes/ocr"
	popupProcess "screen-ocr-llm/src/processes/popup"
	regionProcess "screen-ocr-llm/src/processes/region"
	trayProcess "screen-ocr-llm/src/processes/tray"
...
func delegateToResident(outputToStdout bool) error {
	...
	if !delegated {
		return fmt.Errorf("no resident available")
	}
	if outputToStdout {
		fmt.Print(text)
	}
