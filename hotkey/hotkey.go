...
func keyNameToRawcodes(keyName string) []uint16 {
	...
	case "a": return []uint16{65}
	case "b": return []uint16{66}
	case "c": return []uint16{67}
	case "d": return []uint16{68}
	case "e": return []uint16{69}
	case "f": return []uint16{70}
	case "g": return []uint16{71}
	case "h": return []uint16{72}
	case "i": return []uint16{73}
	case "j": return []uint16{74}
	case "k": return []uint16{75}
	case "l": return []uint16{76}
	case "m": return []uint16{77}
	case "n": return []uint16{78}
	case "o": return []uint16{79}
	case "p": return []uint16{80}
	case "q": return []uint16{81}
	case "r": return []uint16{82}
	case "s": return []uint16{83}
	case "t": return []uint16{84}
	case "u": return []uint16{85}
	case "v": return []uint16{86}
	case "w": return []uint16{87}
	case "x": return []uint16{88}
	case "y": return []uint16{89}
	case "z": return []uint16{90}

	// Number keys (0-9) - VK codes 0x30-0x39 (48-57)
	case "0": return []uint16{48}
	case "1": return []uint16{49}
	case "2": return []uint16{50}
	case "3": return []uint16{51}
	case "4": return []uint16{52}
	case "5": return []uint16{53}
	case "6": return []uint16{54}
	case "7": return []uint16{55}
	case "8": return []uint16{56}
	case "9": return []uint16{57}

	// Function keys (F1-F12)
	case "f1": return []uint16{112}  // VK_F1
	case "f2": return []uint16{113}  // VK_F2
	case "f3": return []uint16{114}  // VK_F3
	case "f4": return []uint16{115}  // VK_F4
	case "f5": return []uint16{116}  // VK_F5
	case "f6": return []uint16{117}  // VK_F6
	case "f7": return []uint16{118}  // VK_F7
	case "f8": return []uint16{119}  // VK_F8
	case "f9": return []uint16{120}  // VK_F9
	case "f10": return []uint16{121} // VK_F10
	case "f11": return []uint16{122} // VK_F11
	case "f12": return []uint16{123} // VK_F12

	// Common special keys
	case "space": return []uint16{32}    // VK_SPACE
	case "enter", "return": return []uint16{13} // VK_RETURN
	case "esc", "escape": return []uint16{27}   // VK_ESCAPE
	case "tab": return []uint16{9}       // VK_TAB
	case "backspace": return []uint16{8} // VK_BACK
	case "delete", "del": return []uint16{46}   // VK_DELETE
	case "insert", "ins": return []uint16{45}   // VK_INSERT
	case "home": return []uint16{36}     // VK_HOME
	case "end": return []uint16{35}      // VK_END
	case "pageup", "pgup": return []uint16{33}  // VK_PRIOR
	case "pagedown", "pgdn": return []uint16{34} // VK_NEXT

	// Arrow keys
	case "left": return []uint16{37}  // VK_LEFT
	case "up": return []uint16{38}    // VK_UP
	case "right": return []uint16{39} // VK_RIGHT
	case "down": return []uint16{40}  // VK_DOWN
